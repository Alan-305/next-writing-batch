    ...
    <main className="tensaku-main">
      ...
      >
        ...
        <article className="tensaku-value">
          <h3>保護者の皆様へ</h3>
          <p>
            「手書きの紙の原本が、画像のままネット上に溜まり続けるのでは」という心配に対し、<strong>蓄積の中心は文字化された英作文であり、筆跡そのものの保管を目的とした設計ではない</strong>とお考えください。お子さまの学籍・表示名などの識別は、答案の本文とは分けて管理する考え方です。住所・電話番号など、学習に直接必要ない情報を取りにいく設計にはしていません。
          </p>
        </article>
        <article className="tensaku-value">
          <h3>教員・学校の方へ</h3>
          <p>
            認証は Google 等の基盤に任せ、パスワード管理の負担をアプリ側に増やさない方針です。生徒向けと教員・運用の操作範囲を分け、生徒が誤って管理機能に入ることを想定に止めています。提出物はテキスト中心で説明しやすく、説明責任の範囲を明確にしやすくしています。利用料のお支払いは専門の決済サービス（Stripe）を利用し、クレジット番号がこのアプリのサーバーを通る形にはしていません。
          </p>
